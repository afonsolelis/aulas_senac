...
- **O percurso das aulas é deliberadamente "arquitetura antes de código"**: requisitos (S35) → arquitetura sem tecnologia + ATAM (S36) → táticas e só então tecnologias (S37) → Docker (S39) → suíte inteira escrita e **vermelha** na casca vazia (S40) → implementação até o verde + pipeline (S41) → RTM e eixos de RNF no Sonar (S42) → laboratório dos alunos (S43+). Não antecipe código nem tecnologia para antes da semana em que entram.
